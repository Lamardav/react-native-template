...
export type TFuncKeyApp = ParseKeys<"translation", LanguageResource>;
...
export const getInterfaceLanguage = () => findBestLanguageTag(languagesTags);
...
export async function setLanguage(inputLanguage?: Languages): Promise<void> {
  ...
  i18n.addResourceBundle(language.languageTag, "translation", translationGetters[language.languageTag]?.()["translation"], true, false);
